...
\end{itemize}
\centering
{\includegraphics[width=5.0cm]{img/edu.png}}
\end{frame}
\begin{frame}
...
\end{itemize}
\centering
{\includegraphics[width=3.0cm]{img/re.png}}
\end{frame}
\begin{frame}
...
\end{itemize}
\centering
{\includegraphics[width=5.0cm]{img/ta.png}}
\end{frame}
...
{\includegraphics[width=5.0cm]{img/a.jpg}}
\item Audiolibros para personas con debilidad visual
{\includegraphics[width=5.0cm]{img/l.jpg}}
\end{itemize}
\end{frame}
